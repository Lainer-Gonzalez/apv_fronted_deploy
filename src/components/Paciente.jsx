...
const Paciente = ({paciente}) => {
    ...
    const formatearFecha = (fecha) => {
        ...
        return new Int.DateTimeFormat('es-MX', {dateStyle: 'long'}).format(nuevaFecha)
    }
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <div className="flex justify-between my-5">
            <button
                type="button"
                className="py-2 px-10 bg-indigo-600 hover:bg-red-700 text-white uppercase font-bold ronded-lg"
